...
const ICONS = ['fa-heart', 'fa-circle', 'fa-square', 'fa-3x fa-minus', 'fa-play'];

// set colours
const COLOURS = [[0, 0, 0], [211, 47, 47], [0, 145, 234], [100, 221, 23], [255, 235, 59], [170, 0, 255]];
...
var parseGameInfo = function(gameInformation) {
  ...
  app.rankings = gameInformation.rankings;
};
